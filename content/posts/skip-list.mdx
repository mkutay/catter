...
<Image
  alt="An example of a sequence-based priority queue on a sorted list with trivial insertion."
  src="/images/skip-list/n-squared-insertion.png"
  width={0}
  height={0}
  sizes="100vw"
...
<Image
  alt="An example situation of inserting into the list a number."
  src="/images/skip-list/example-situation.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="An example situation of inserting into the list a number with an express lane."
  src="/images/skip-list/express-lane.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="Some formal structure of the linked list with express lanes."
  src="/images/skip-list/first-look-at-the-structure.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="Some formal structure of the linked list with express lanes including a search path."
  src="/images/skip-list/first-look-at-the-structure-search-path.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="Some formal structure of the skip list with head nodes."
  src="/images/skip-list/structure-with-head.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="Some formal structure of the skip list with layer names."
  src="/images/skip-list/structure-with-layers.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="Some formal structure of the skip list with node names on the bottom."
  src="/images/skip-list/structure-with-nodes.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="Some formal search path on an actual skip list."
  src="/images/skip-list/formal-search-path.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
...
<Image
  alt="An example with lengths written on the skip list."
  src="/images/skip-list/list-interface.png"
  width={0}
  height={0}
  sizes="100vw"
  style={{ width: "100%", height: "auto" }}
