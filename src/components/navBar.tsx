...
export const Logo: React.FC<IconSvgProps> = ({
  ...
  >
    ...
    <g clipPath="url(#ArtboardFrame)">
      ...
      />
      <path
        d="M678.17 48.7391L678.17 1950.77L50.2695 1950.77L50.2695 48.7391L678.17 48.7391Z"
        fill="none"
        opacity="1"
        stroke="currentColor"
        strokeLinecap="butt"
      ...
      />
      <path
        d="M999.997 1176.75L648.478 822.756"
        fill="none"
        opacity="1"
        stroke="currentColor"
        strokeLinecap="butt"
      ...
      />
      <path
        d="M356.343 1169.82L714.94 822.99"
        fill="none"
        opacity="1"
        stroke="currentColor"
        strokeLinecap="butt"
      ...
      />
      <path
        d="M971.827 823.375L1324.59 1176.14"
        fill="none"
        opacity="1"
        stroke="currentColor"
        strokeLinecap="butt"
      ...
      />
      <path
        d="M1615.5 828.052L1258.13 1176.14"
        fill="none"
        opacity="1"
        stroke="currentColor"
        strokeLinecap="butt"
  ...
  return (
    <nav className="bg-background/80 backdrop-blur-xs lg:sticky top-0 h-fit z-50">
      <div className="my-4 max-w-prose md:max-w-6xl mx-auto flex flex-row items-center justify-between px-4">
        <div className="place-items-center text-primary hover:opacity-80 transition-opacity font-semibold tracking-wide text-lg gap-2 flex flex-row items-center">
